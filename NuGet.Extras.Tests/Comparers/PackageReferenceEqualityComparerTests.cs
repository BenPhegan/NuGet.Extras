    ...
    public class PackageReferenceEqualityComparerTests
    {
        ...
        private static IEnumerable<PackageReference> CreatePackageReferenceList(string id1, string v1, string vs1, string id2, string v2, string vs2)
        {
            var packages = new List<PackageReference>
                               {
                                   new PackageReference(id1, v1 == null ? null : SemanticVersion.Parse(v1), vs1 == null ? null : VersionUtility.ParseVersionSpec(vs1)),
                                   new PackageReference(id2, v2 == null ? null : SemanticVersion.Parse(v2), vs2 == null ? null : VersionUtility.ParseVersionSpec(vs2))
                               };
            return packages;
        }
